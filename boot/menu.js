...
(function() {
  ...
  'system': { name: 'System & Tools', icon: '⚙️', keywords: ['control', 'settings', 'debug', 'about', 'manager'] },
  ...
  'internet': { name: 'Internet', icon: '🌐', keywords: ['web', 'browser', 'email'] },
  'utilities': {name: 'Utilities', icon: '🧭', keywords: ['weather', 'calendar', 'clock', 'file', 'pakogzip', 'utility', 'terminal']},
